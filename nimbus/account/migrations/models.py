...
class UserManager(BaseUserManager):
    ...
    def create_user(self,email,password=None,is_active=True,is_student = False, is_teacher = False,is_hod = False ,is_staff=False, is_admin= False):
        if not email:
